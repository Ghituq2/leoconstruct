...
const Navbar = () => {
  ...
  return (
    <>
          ...
          <div className="relative h-full flex items-center justify-between px-4">
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="text-orange-400 text-xs lg:text-sm tracking-[0.2em] uppercase whitespace-nowrap drop-shadow-sm">Excelență în Construcții</span>
              </div>
            </button>
      ...
      {/* Mobile menu - moved outside of nav to prevent inheriting transparency */}
      <div 
        className={`lg:hidden fixed inset-0 z-40 bg-slate-900 shadow-xl transition-all duration-300 ${
          open ? "translate-y-0 opacity-100" : "-translate-y-full opacity-0"
        }`}
      >
        <div className={`flex flex-col items-center justify-start min-h-screen pt-[60px] transition-all duration-300 ${
          ...
          <div className="w-full flex flex-col items-center py-8">
            <img 
              src="/images/logo.png" 
              alt="LEO Construct logo" 
              className="h-32 w-32 rounded object-contain mb-4"
            />
            ...
            {navLinks.map(link => (
              link.isExternal ? (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="relative w-full text-center py-8 text-4xl font-medium text-white uppercase tracking-widest transition-all duration-300
                  after:content-[''] after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 
                  after:w-48 after:h-0.5 after:bg-orange-500/5
